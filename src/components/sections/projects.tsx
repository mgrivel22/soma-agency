        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {projects.map((project, index) => (
            <FadeIn key={project.slug} delay={index * 0.06}>
              <article className="group flex h-full flex-col overflow-hidden rounded-2xl border border-white/8 bg-zinc-900/80 shadow-[0_12px_40px_-28px_rgba(0,0,0,0.9)] transition-all duration-300 hover:-translate-y-1 hover:border-emerald-400/25 hover:shadow-[0_24px_50px_-28px_rgba(16,185,129,0.25)]">
                {project.previews ? (
                  <ProjectImagePreview
